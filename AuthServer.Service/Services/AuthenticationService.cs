...
namespace AuthServer.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<Response<TokenDto>> CreateTokenAsync(LoginDto loginDto)
        {
            ...
            if (userRefreshToken == null)//veritabanında daha önce bir refresh token kaydedilmemiş
            {
            ...
            {
                userRefreshToken.Code = token.RefreshToken;//update
                userRefreshToken.Expiration = token.RefreshTokenExpiration;//update
            }
